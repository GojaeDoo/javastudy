...
public class Ex01_Main {
	public static void main(String[] args) {
		...
		System.out.println("=== 나이가 20이상인 고객의 명단(입력순) ===");
		
		System.out.println("=== 나이가 20이상인 고객의 명단(오름차순) ===");
		...
		stream.map(i->i.getName()).forEach(i->System.out.println(i+"손님"));
		
		// 위에서 최종 처리를 했으므로 다시 stream을 만들어 사용
