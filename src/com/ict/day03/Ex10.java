...
public class Ex10 {
	public static void main(String[] args) {
		...
		// java.lang 이외에 존재하는 클래스를 사용하기 위해서 import를 해야 한다.
		// 해당 클래스에 위치를 표시하므로 해당 클래스를 사용할 수 있게 한다.
		
		// 키보드에 입력한 정보를 받아서 변수(scan)에 저장
		...
		System.out.println("당신의 키는 " + (height+1) + "cm 입니다.");
