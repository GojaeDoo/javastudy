...
public class Ex01 {
	public static void main(String[] args) {
		...
		//          defaut : 인자값과 조건값1, 2, 3 모두 같지 않을 때 수행할 문장;
		//        }
		//
		...
		if (k1 == 1) {
			...
			System.out.println("1~4가지 중에 하나를 골라주세요");
		}
		...
		// char k2이 A면 아프리카 , B이면 브라질, C이면 캐나다 나머지 한국
		...
		// char k3가 A 이거나 a이면 아프리카 B이거나 b이면 브라질 C이거나 c이면 캐나다 나머지는 한국
		...
		// String k5 이 한국이면 서울, 중국이면 베이징, 일본이면 도쿄, 미국이면 워싱턴
