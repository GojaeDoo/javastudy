...
public class Ex08 {
	public static void main(String[] args) {
		...
		// 입력된 String을 넣어주면 해당 문자열에 입력된 String이 존재하면 true , 존재하지 않으면 flase

		String s5 = "minchoi9979@gmail.com";
		boolean res = s5.contains("@");
		// boolean res = s5.contains('@); char 사용 못함
		System.out.println("결과는 : " + res);
		System.out.println("결과는 : " + s5.contains(".com"));
		System.out.println("결과는 : " + s5.contains(".COM")); // 대문자 소문자 구분 가능
		...
		// 13. isEmpty() : boolean
		// 해당 문자열이 비어 있으면 true , 내용이 있으면 flase;
		String str5 = "대한민국";
		...
		// String t5 = t4.replace("9999", "****");
		// System.out.println(t5);

		// String t6 = "010-7777-9999";
		// String t7 = t4.replace("7777", "****");
		...
		// 어떤 기본 자료형이든 String으로 변형 시킴 (기본자료형 + "")
		boolean bo1 = true;
		char ch1 = 'c';
		int num1 = 34;
		long num2 = 37L;
		...
		// 22-1. "true" , "false" 문자열을 기본자료형인 boolean형으로 변경 :
		// boolean.parseBoolean(String);
		// "true" , "false" => 실제 true , false로 바뀐다.
		// "true" 를 제외한 문자열이면 => flase
		...
		// String.(String regex. int limit) : String []
